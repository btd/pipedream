...
module.exports = function staticCache(options){
  ...
  return function staticCache(req, res, next){
    ...
    // cache static
    // TODO.md: change from staticCache() -> cache()
    ...
    req.on('static', function(stream){
      ...
      // TODO.md: real support for must-revalidate / no-cache
      if ( cc['no-cache']
        || cc['no-store']
        || cc['private']
      ...
      stream.on('end', function(){
        ...
        delete headers['x-cache']; // Clean up (TODO.md: others)
        cacheEntry.push(200);
 ...
 * TODO.md: Assume 200 code, that's iffy.
 *
 * @param {Object} req
 * @param {Object} res

...
Request.prototype.end = function(fn){
  ...
  req.on('response', function(res){
    ...
    // TODO.md: make all parsers take callbacks
    if (multipart) {
      var form = new formidable.IncomingForm;

      form.parse(res, function(err, fields, files){
        if (err) throw err;
        // TODO.md: handle error
        // TODO.md: emit formidable events, parse json etc
    ...
    self.res = res;
    res.on('end', function(){
      // TODO.md: unless buffering emit earlier to stream
      var response = new Response(self.req, self.res);
      response.redirects = self._redirectList;
      self.emit('response', response);
      self.emit('end');

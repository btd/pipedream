...
pipedream.pkg("pipedream", function(parents){

  return {
    'name'         : 'backbone',
    'mainModuleId' : 'backbone',
    'modules'      : [],
    'parents'      : parents
  };

})({ 'backbone': function(module, exports, global, require, undefined){
  //     Backbone.js 0.9.10
...
pipedream.pkg("pipedream", function(parents){
  ...
  return {
    'name'         : 'dust',
    'mainModuleId' : 'lib/dust',
    'modules'      : [],
    'parents'      : parents
  };

})({ 'lib/compiler': function(module, exports, global, require, undefined){
  (function(dust) {
...
dust.optimizers = {
  ...
  format:    nullify,        // TODO.md: convert format
  reference: visit,
  "#":       visit,
  "?":       visit,
  "^":       visit,
...
dust.nodes = {
  ...
  "%": function(context, node) {
    // TODO.md: Move these hacks into pragma precompiler
    var name = node[1][1];
...
'lib/dust': function(module, exports, global, require, undefined){
  var dust = {};
...
'lib/parser': function(module, exports, global, require, undefined){
  (function(dust){
...
pipedream.pkg("pipedream", function(parents){
  ...
  return {
    'name'         : 'lodash',
    'mainModuleId' : 'dist/lodash',
    'modules'      : [],
    'parents'      : parents
  };

})({ 'dist/lodash': function(module, exports, global, require, undefined){
  /**
 * @license
...
pipedream.pkg(function(parents){

  return {
    'name'         : 'pipedream',
    'mainModuleId' : 'app/client/app',
    'modules'      : [],
    'parents'      : parents
  };

})({ 'app/client/app': function(module, exports, global, require, undefined){
